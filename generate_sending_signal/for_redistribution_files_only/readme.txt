generate_sending_signal MATLAB Java Package
...
- generate_sending_signal.jar must be included in your CLASSPATH.
...
-MCRInstaller.exe 
    ...
    Deployment Tool.
-Javadoc   
   - javadoc for generate_sending_signal is in the doc directory. When  
