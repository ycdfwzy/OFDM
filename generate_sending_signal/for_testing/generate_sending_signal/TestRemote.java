...
/**
 * The <code>TestRemote</code> class provides a Java RMI-compliant interface to MATLAB 
 ...
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>TestRemote</code> 
 ...
 * generate RMI server proxy objects for instances of generate_sending_signal.Test.
 */
public interface TestRemote extends Poolable
{
    /**
     * Provides the standard interface for calling the 
     * <code>decode_received_signal</code> MATLAB function with 1 input argument.  
     *
     ...
     */
    public Object[] decode_received_signal(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the 
     * <code>generate_sending_signal</code> MATLAB function with 1 input argument.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     * supported Java type (i.e. scalars and multidimensional arrays of any numeric, 
     ...
     * in communication with the server.
     */
    public Object[] generate_sending_signal(int nargout, Object... rhs) throws RemoteException;
